	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getStructureElementAccess().getAlternatives(), "rule__StructureElement__Alternatives");
					...
					put(grammarAccess.getArchitectureViewAccess().getGroup(), "rule__ArchitectureView__Group__0");
					put(grammarAccess.getSoftwareSystemAccess().getGroup(), "rule__SoftwareSystem__Group__0");
					...
					put(grammarAccess.getArchitectureViewAccess().getNameAssignment_1(), "rule__ArchitectureView__NameAssignment_1");
					put(grammarAccess.getSoftwareSystemAccess().getNameAssignment_1(), "rule__SoftwareSystem__NameAssignment_1");
